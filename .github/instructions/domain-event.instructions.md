---
applyTo: "src/MenuHelper.Domain/DomainEvents/*.cs"
---
...
- 类文件应放置在 `src/MenuHelper.Domain/DomainEvents` 目录下。
- 为每个聚合添加一个领域事件文件。
...
**文件**: `src/MenuHelper.Domain/DomainEvents/UserDomainEvents.cs`

```csharp
using MenuHelper.Domain.Aggregates.UserAggregate;
