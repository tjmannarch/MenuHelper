---
applyTo: "src/MenuHelper.Web/Application/DomainEventHandlers/*.cs"
---
...
- 类文件应放置在 `src/MenuHelper.Web/Application/DomainEventHandlers/` 目录下。
...
using MenuHelper.Web.Domain.DomainEvents;
