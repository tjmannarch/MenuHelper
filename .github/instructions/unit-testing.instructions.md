...
- 领域层测试：`test/MenuHelper.Domain.Tests/{EntityName}Tests.cs`。
- Web 层测试：`test/MenuHelper.Web.Tests/{Feature}Tests.cs`。
- 基础设施层测试：`test/MenuHelper.Infrastructure.Tests/{Component}Tests.cs`。
